...
<a href="index.php?page=petugastambah" class="btn btn-primary">Tambah Petugas</a>
...
<table align="center" class="table table-bordered table-striped table-hover" border="1">
    ...
    ?>
        ...
        <tr>
            ...
            <td align="center">
                <a href="halaman/petugas/petugasubah.php?idpetugas=<?php echo $tampildata['idpetugas']; ?>">
                    Edit
                </a>
                |
                <a href="halaman/petugas/petugashapus.php?idpetugas=<?php echo $tampildata['idpetugas']; ?>" onclick="return confirm('Apa Anda yakin akan menghapus Data Buku?')">
                    Delete
                </a>
            </td>
        </tr>
...
<nav>
    <ul class="pagination justify-content-center">
        ...
        for ($i = 1; $i <= $jumlahhalaman; $i++) {
            if ($i != $halaman) {
        ?>
                <li class="page-item"><a class="page-link" href="../admin/index.php?page=petugas&halaman=<?php echo $i; ?>"><?php echo $i; ?></a></li>
        <?php
            } else {
